document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function initPage() {
        // await checkUserSession(); // Ya no es necesario aquí si currentUser se obtiene antes
        ...
        // Cerrar sesión (ya manejado por initTechnicianPage)
        /*
    ...
    // initPage(); // Se llama después de obtener currentUser
});
